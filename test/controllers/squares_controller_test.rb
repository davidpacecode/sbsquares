...
class SquaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create square" do
    assert_difference("Square.count") do
      post squares_url, params: { square: { column: @square.column, game_id: @square.game_id, row: @square.row, user_id: @square.user_id } }
    end
  ...
  test "should update square" do
    patch square_url(@square), params: { square: { column: @square.column, game_id: @square.game_id, row: @square.row, user_id: @square.user_id } }
